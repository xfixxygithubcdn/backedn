...
app.use(express.urlencoded({ limit: '50000000000mb', extended: true, parameterLimit: 5000000000 }));
...
app.get('/secrets/void/injection/uwu', async (req, res) => {
    await res.sendFile("others/injection.js", { root: __dirname }, (err) => {
        return;
     });
})
